import 'package:lspazrieal/constant/route_constants.dart';
import 'package:lspazrieal/helper/dbhelper.dart';
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    NavButton(
                        imagePath: 'assets/images/pemasukan_azrieal.jpeg',
                        label: "Tambah Pemasukan",
                        onTap: () {
                          Navigator.pushNamed(context, addIncomeRoute);
                        }),
                    NavButton(
                        imagePath: 'assets/images/pengeluaran_azrieal.jpeg',
                ...
                Row(
                  ...
                  children: [
                    NavButton(
                        imagePath: 'assets/images/cashflow_azrieal.jpg',
                        label: "Detail Cash Flow",
                        onTap: () {
                          Navigator.pushNamed(context, detailCashFlowRoute);
                        }),
                    NavButton(
                        imagePath: 'assets/images/setting-azrieal.png',
                        label: "Pengaturan",
                        onTap: () {
